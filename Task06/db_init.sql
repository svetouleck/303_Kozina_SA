...
(9,'14:00','16:00','14:00','16:00','14:00','16:00','14:00','16:00','14:00','16:00','14:00','16:00','NULL','NULL'),
(10,'12:00','21:00','12:00','21:00','12:00','21:00','12:00','21:00','12:00','21:00','NULL','NULL','NULL','NULL');


 INSERT INTO master (id, name, last_name, patronymic, gender, id_specialization, percent, id_person_schedules, status) VALUES
...
(3,'Белова', 'Анастасия', 'Демидовна','Ж',0,11,3,'уволен'),
(4,'Игнатьев', 'Егор', 'Иванович','М',1,0,4,'работает'),
(5,'Волкова', 'Кристина', 'Михайловна','Ж',0,19,5,'работает'),
...
(0,'2021-04-10','16:00', 0),
(1,'2021-03-17','14:30', 1),
(2,'2021-04-03','18:00', 2),
(3,'2021-04-11','11:30', 3),
(4,'2021-03-27','9:00', 4),
(5,'2021-04-10','8:00', 5),
(6,'2021-04-10','10:00', 6),
